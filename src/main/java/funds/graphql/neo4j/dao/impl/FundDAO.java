package funds.graphql.neo4j.dao.impl;
...
import funds.graphql.neo4j.dao.IFundDAO;
...
public class FundDAO implements IFundDAO {
	...
	// @Override
	// public List<Fund> searchMember(String memberName, Long empId, String skillBucket, String projectName) {
	// 	List<Fund> members = new ArrayList<Fund>();
	...
	// 	 while (itr.hasNext()) {
	// 		 members.add((Fund) itr.next().get("m"));
	// 		  }
	// 	return members;
	// }
}
